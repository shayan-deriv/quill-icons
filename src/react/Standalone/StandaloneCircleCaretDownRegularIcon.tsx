...
export const StandaloneCircleCaretDownRegularIcon = (
  ...
  >
    ...
    <path d='M16 25.25a8.63 8.63 0 0 0 7.54-4.375c1.6-2.695 1.6-6.016 0-8.75C21.976 9.43 19.124 7.75 16 7.75a8.73 8.73 0 0 0-7.578 4.375c-1.602 2.734-1.602 6.055 0 8.75C9.984 23.609 12.836 25.25 16 25.25M16 6.5c3.555 0 6.836 1.914 8.633 5 1.797 3.125 1.797 6.914 0 10a9.93 9.93 0 0 1-8.633 5c-3.594 0-6.875-1.875-8.672-5-1.797-3.086-1.797-6.875 0-10 1.797-3.086 5.078-5 8.672-5m0 13.75a1.42 1.42 0 0 1-1.016-.43l-3.71-3.984c-.196-.195-.274-.469-.274-.742 0-.586.469-1.094 1.055-1.094h7.851c.586 0 1.094.508 1.094 1.094 0 .273-.117.547-.312.742l-3.711 3.984c-.274.274-.625.43-.977.43m.04-1.25 3.476-3.75h-7.07L15.921 19h.118' />
  </svg>
);
