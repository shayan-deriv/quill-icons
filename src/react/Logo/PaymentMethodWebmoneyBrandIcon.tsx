...
const PaymentMethodWebmoneyBrandIcon = (
  ...
  >
    ...
    <g fill='#0068A3'>
      ...
      <path d='m105.45 39.08 3.51-3.14 3.15 3.48-3.5 3.14zm6 2.88-3.51 3.13 3.16 3.48 3.51-3.13zm-8.51-8.83 3.51-3.14 3.15 3.49-3.51 3.13zm9.07-4.04-2.63 2.35 2.36 2.61 2.64-2.35zm2.04 13.12 2.63-2.35 2.37 2.61-2.63 2.35zm4.95 2.92-2.64 2.35 2.37 2.62 2.63-2.35zm-1.58-9.73 1.76-1.57 1.58 1.74-1.76 1.57zm-.48-6.74-1.76 1.56 1.58 1.75 1.76-1.57zm2.73 11.91 1.75-1.57 1.58 1.74-1.75 1.57zm-5.24-6.23-2.63 2.35 2.37 2.61 2.63-2.35zM11.88 37.48h-.11l-2.23 8.33H7.73L5 33.97h1.88l1.89 8.84h.12l2.19-8.84h1.49l2.34 8.84h.12l1.72-8.84h1.97l-2.73 11.84h-1.82z' />
      <path
        fillRule='evenodd'
        d='M26.18 45.27V44a5.1 5.1 0 0 1-2.68.89c-1.73 0-2.56-.89-2.56-2.89h5.46v-.63c0-2.73-1.3-4.08-3.4-4.08-2.52 0-3.82 1.74-3.82 4.38s1.17 4.37 4 4.37a5.93 5.93 0 0 0 3-.77m-1.33-4.44H21c.16-1.67 1.09-2.45 2-2.45s1.77.7 1.85 2.45m4.84-2.95a5.06 5.06 0 0 1 2.31-.62c2.09 0 3.22 1.44 3.22 4.11 0 3.12-1.52 4.64-4 4.64a7.8 7.8 0 0 1-3.22-.82V33.53l1.75-.41zm0 6.7a4 4 0 0 0 1.55.26c1.25 0 2.19-.76 2.19-3.47 0-2.12-.77-2.81-1.9-2.81a3.65 3.65 0 0 0-1.84.55z'
        clipRule='evenodd'
      />
...
const ForwardRef = forwardRef(PaymentMethodWebmoneyBrandIcon);
