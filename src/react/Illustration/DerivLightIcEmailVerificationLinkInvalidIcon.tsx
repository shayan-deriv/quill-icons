...
const DerivLightIcEmailVerificationLinkInvalidIcon = (
  ...
  >
    ...
    <g clipPath='url(#d74f79cb68e7aa7129111913892a2706__a)'>
      <mask
        id='d74f79cb68e7aa7129111913892a2706__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#d74f79cb68e7aa7129111913892a2706__b)'>
        <path
          fill='#BBCCCE'
        ...
        <path
          fill='#fff'
          fillRule='evenodd'
          d='M105.114 24.83a1.54 1.54 0 0 0 1.027-.495c.315-.341.382-.783.408-.957l.005-.032.893-5.542q.053-.329.053-.662V14.23c0-.707-.169-1.827-1.157-2.378a2.73 2.73 0 0 0-1.374-.352c-.53.005-.974.16-1.323.356-.981.552-1.146 1.665-1.146 2.366v2.914q0 .341.055.676l.91 5.535.005.032c.027.175.096.62.416.96.305.327.75.523 1.228.49m-2.614 6.943v.454c0 .573.175 1.174.648 1.627.47.45 1.12.646 1.851.646.732 0 1.383-.196 1.853-.646.473-.454.648-1.054.648-1.627v-.454c0-.573-.175-1.174-.648-1.628-.471-.45-1.121-.645-1.853-.645-.731 0-1.381.195-1.851.646-.473.453-.648 1.054-.648 1.627'
          clipRule='evenodd'
        />
      </g>
    </g>
    <defs>
      <clipPath id='d74f79cb68e7aa7129111913892a2706__a'>
        <path fill='#fff' d='M0 0h128v128H0z' />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(DerivLightIcEmailVerificationLinkInvalidIcon);
