...
const DerivDarkSpamFolderIcon = (
  ...
  >
    ...
    <path
      fill='#fff'
      fillRule='evenodd'
      d='m19.383 13.597 1.023 1.024a.2.2 0 0 1 .062.153v1.452q0 .092-.064.156l-1.024 1.023a.23.23 0 0 1-.155.064h-1.45a.22.22 0 0 1-.156-.066l-1.023-1.024a.23.23 0 0 1-.064-.155v-1.45a.22.22 0 0 1 .064-.153l1.026-1.026a.22.22 0 0 1 .153-.064h1.452a.22.22 0 0 1 .155.066m-.248 3.434.897-.897v-1.268l-.897-.897h-1.269l-.896.897v1.268l.896.897zm-.634-.875a.219.219 0 1 0 0 .438.219.219 0 0 0 0-.438m-.219-1.531a.22.22 0 0 1 .219-.219.22.22 0 0 1 .219.219v1.094a.22.22 0 0 1-.22.219.22.22 0 0 1-.218-.22z'
      clipRule='evenodd'
    />
  </svg>
);
