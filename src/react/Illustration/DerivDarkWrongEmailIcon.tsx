...
const DerivDarkWrongEmailIcon = (
  ...
  >
    ...
    <path
      fill='#fff'
      fillRule='evenodd'
      d='M8.364 7.59h.363c.101 0 .182.082.182.183v1c0 .1-.08.181-.182.181H7.273a.18.18 0 0 1-.182-.181v-1a.18.18 0 0 1 .182-.182h.363v-.182c0-.101.081-.182.182-.182h.364c.1 0 .182.081.182.182zm-.546 0h.364v-.18h-.364z'
      clipRule='evenodd'
    />
    <path
      fill='#323738'
    ...
    <path
      fill='#fff'
      fillRule='evenodd'
      d='M16.364 15.728a.364.364 0 1 1-.728 0 .364.364 0 0 1 .728 0m-1.091.909c0-.242.484-.364.727-.364s.727.122.727.364v.09a.09.09 0 0 1-.09.091h-1.273a.09.09 0 0 1-.091-.09z'
      clipRule='evenodd'
    />
  </svg>
);
