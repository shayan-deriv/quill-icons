...
const DerivLightCrashBoomIcon = (
  ...
  >
    ...
    <g stroke='#000' strokeLinecap='round' strokeLinejoin='round' strokeWidth={0.571}>
      ...
      <path
        fill='#fff'
        d='m27.693 96.804 15.24-8.986 4.334-2.555.214-.126 9.85 17.333.019.033 6.774 11.921V43.577L46.817 32.99l23.976-18.57 1.747 3.332 6.129 11.693 5.448 10.393 11.97 22.834-11.97-7.132-4.376-2.605-2.412-1.437v85.01H63.966L47.48 107.463l-10.404 6z'
      />
      <path
        fill='#EBECEE'
