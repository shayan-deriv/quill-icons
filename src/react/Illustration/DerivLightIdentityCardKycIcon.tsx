...
const DerivLightIdentityCardKycIcon = (
  ...
  >
    ...
    <path
      fill='#fff'
      fillRule='evenodd'
      d='m43.666 41.168.667 2.667 1.666-1.334-.333-1.333zm6.001 0-.666 2.667-1.667-1.334.333-1.333z'
      clipRule='evenodd'
    />
    <path
      fill='#C7E5E5'
    ...
    <path
      fill='#E3E4E3'
      d='M28.915 36H8.085C7.485 36 7 36.486 7 37.085v.83c0 .6.486 1.085 1.085 1.085h20.83c.6 0 1.085-.486 1.085-1.085v-.83c0-.6-.486-1.085-1.085-1.085m0 6H8.085C7.485 42 7 42.486 7 43.085v.83c0 .6.486 1.085 1.085 1.085h20.83c.6 0 1.085-.486 1.085-1.085v-.83c0-.6-.486-1.085-1.085-1.085'
    />
    <path
      fill='#84ABAE'
      fillRule='evenodd'
