  ...
  >
    ...
    <g clipPath='url(#46dd43eca)'>
      ...
      <path
        fill='#fff'
        fillRule='evenodd'
        d='M9.753 7.09a1.25 1.25 0 0 1 1.337-1.337c.661.045 1.16.623 1.16 1.286v.137c0 .18-.103.351-.27.417a.46.46 0 0 1-.538-.151.625.625 0 1 1-.35-1.06.64.64 0 0 1 .533.64v.156c0 .099.088.196.187.196S12 7.277 12 7.178v-.137c0-.467-.303-.894-.755-1.009-.725-.188-1.4.489-1.214 1.214.116.451.544.753 1.01.753h.459c.069 0 .125.057.125.125a.125.125 0 0 1-.125.125h-.461c-.663 0-1.24-.498-1.286-1.16m.872-.09a.374.374 0 1 0 .749 0 .374.374 0 0 0-.75 0'
        clipRule='evenodd'
      />
    </g>
    <defs>
      <clipPath id='46dd43eca'>
