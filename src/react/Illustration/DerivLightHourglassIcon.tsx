...
const DerivLightHourglassIcon = (
  ...
  >
    ...
    <path
      fill='#B2C6C7'
      d='M110.727 128H16.846c-1.589 0-2.846-1.322-2.846-2.954v-3.692c0-1.632 1.288-2.954 2.876-2.954h93.843c1.589 0 2.877 1.322 2.877 2.953v3.695c0 1.631-1.281 2.952-2.869 2.952m0-118.4H16.846C15.257 9.6 14 8.278 14 6.646V2.954C14 1.322 15.288 0 16.876 0h93.843c1.589 0 2.877 1.322 2.877 2.953v3.695c0 1.631-1.281 2.952-2.869 2.952'
    />
    <path
      fill='#BCE1E1'
    ...
    <path
      fill='#D9F2F1'
      d='M51.47 79.465c-8.355 4.824-13.4 18.553-14.878 24.814-.492 2.175.653 1.467 1.084.494.394-.89 2.03-5.042 5.813-11.764 4.729-8.403 6.108-8.897 8.571-11.962 1.97-2.452.427-2.077-.59-1.582m12.418-9.237c-3.596-.144-1.738-4.375-.36-6.472.136-.207.3-.09.36 0 1.378 2.097 3.595 6.328 0 6.472'
    />
  </svg>
);
