...
const DerivLightIcEmailSentPasskeyIcon = (
  ...
  >
    ...
    <g fillRule='evenodd' clipRule='evenodd'>
      ...
      <path
        fill='#FF444F'
        d='M98 38.993h16.618L88 13v15.993c0 5.523 4.478 10 10 10M98.903 49h-67.94c-1.65 0-3-1.35-3-3s1.35-3 3-3h67.94c1.649 0 3 1.35 3 3s-1.351 3-3 3m0 14h-67.94c-1.65 0-3-1.35-3-3s1.35-3 3-3h67.94c1.649 0 3 1.35 3 3s-1.351 3-3 3M65.082 77h-34.12c-1.65 0-3-1.35-3-3s1.35-3 3-3h34.12c1.65 0 3 1.35 3 3s-1.35 3-3 3'
      />
      <path
        fill='#5C616D'
