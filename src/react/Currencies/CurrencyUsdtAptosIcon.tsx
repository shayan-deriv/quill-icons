...
export const CurrencyUsdtAptosIcon = (
  ...
  >
    ...
    <path
      fill='#0F0E0B'
      d='M20.875 24.3a4.8 4.8 0 0 0-.424-1.391h-2.48l-.903-1.392h2.378A4.94 4.94 0 0 0 16 20.125a4.94 4.94 0 0 0-3.446 1.392h4.514l-.903 1.392.903 1.391zM13.456 27.084l-.903 1.391c.888.861 2.102 1.4 3.444 1.4s2.576-.512 3.468-1.4H14.36zM14.359 25.692h-3.234a4.8 4.8 0 0 0 .424 1.392h1.907z'
    />
    <path
      fill='#0F0E0B'
