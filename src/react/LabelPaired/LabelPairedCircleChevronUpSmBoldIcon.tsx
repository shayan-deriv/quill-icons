...
const LabelPairedCircleChevronUpSmBoldIcon = (
  ...
  >
    ...
    <path d='M7 5.063c-2.05 0-3.91 1.093-4.95 2.843a5.71 5.71 0 0 0 0 5.688A5.7 5.7 0 0 0 7 16.438a5.68 5.68 0 0 0 4.922-2.844 5.71 5.71 0 0 0 0-5.688C10.882 6.156 9.023 5.063 7 5.063M7 17.75a6.96 6.96 0 0 1-6.07-3.5c-1.258-2.16-1.258-4.812 0-7A7.02 7.02 0 0 1 7 3.75c2.488 0 4.785 1.34 6.043 3.5 1.258 2.188 1.258 4.84 0 7A6.95 6.95 0 0 1 7 17.75m3.309-6.59h-.028c.274.274.274.684 0 .93-.246.273-.656.273-.93 0L6.974 9.71l-2.38 2.38a.6.6 0 0 1-.902 0c-.273-.246-.273-.656 0-.93l2.844-2.844c.246-.246.656-.246.93 0z' />
  </svg>
);
