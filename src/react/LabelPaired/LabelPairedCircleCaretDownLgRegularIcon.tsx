...
const LabelPairedCircleCaretDownLgRegularIcon = (
  ...
  >
    ...
    <path d='M10 24.25a8.63 8.63 0 0 0 7.54-4.375c1.6-2.695 1.6-6.016 0-8.75C15.976 8.43 13.124 6.75 10 6.75a8.73 8.73 0 0 0-7.578 4.375c-1.602 2.734-1.602 6.055 0 8.75C3.984 22.609 6.836 24.25 10 24.25M10 5.5c3.555 0 6.836 1.914 8.633 5 1.797 3.125 1.797 6.914 0 10a9.93 9.93 0 0 1-8.633 5c-3.594 0-6.875-1.875-8.672-5-1.797-3.086-1.797-6.875 0-10 1.797-3.086 5.078-5 8.672-5m0 13.75a1.42 1.42 0 0 1-1.016-.43l-3.71-3.984C5.077 14.64 5 14.367 5 14.094 5 13.508 5.469 13 6.055 13h7.851c.586 0 1.094.508 1.094 1.094 0 .273-.117.547-.312.742l-3.711 3.984c-.274.274-.625.43-.977.43m.04-1.25 3.476-3.75h-7.07L9.921 18z' />
  </svg>
);
