...
const LabelPairedCircleArrowUpLeftSmRegularIcon = (
  ...
  >
    ...
    <path d='M7 4.625a6.11 6.11 0 0 0-5.305 3.063c-1.12 1.914-1.12 4.238 0 6.125C2.79 15.727 4.785 16.875 7 16.875a6.04 6.04 0 0 0 5.277-3.062c1.121-1.887 1.121-4.211 0-6.126A6.1 6.1 0 0 0 7 4.626M7 17.75a6.96 6.96 0 0 1-6.07-3.5c-1.258-2.16-1.258-4.812 0-7A7.02 7.02 0 0 1 7 3.75c2.488 0 4.785 1.34 6.043 3.5 1.258 2.188 1.258 4.84 0 7A6.95 6.95 0 0 1 7 17.75m1.531-9.625a.47.47 0 0 1 .438.438A.45.45 0 0 1 8.53 9H5.85l3.637 3.637a.463.463 0 0 1 0 .629.463.463 0 0 1-.629 0L5.25 9.629V12.5a.45.45 0 0 1-.437.438.43.43 0 0 1-.438-.438V8.563a.45.45 0 0 1 .438-.438z' />
  </svg>
);
