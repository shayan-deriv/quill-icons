...
const LabelPairedCircleOneCaptionBoldIcon = (
  ...
  >
    ...
    <path d='M10.875 9.5c0-1.734-.937-3.328-2.437-4.219a4.89 4.89 0 0 0-4.876 0A4.87 4.87 0 0 0 1.126 9.5a4.88 4.88 0 0 0 2.438 4.242c1.5.867 3.351.867 4.874 0 1.5-.89 2.438-2.484 2.438-4.242M0 9.5a5.96 5.96 0 0 1 3-5.18 5.97 5.97 0 0 1 6 0 6 6 0 0 1 3 5.18 6.01 6.01 0 0 1-3 5.203 5.97 5.97 0 0 1-6 0A5.97 5.97 0 0 1 0 9.5m6.281-2.906a.56.56 0 0 1 .282.468v4.313H7.5a.57.57 0 0 1 .563.563.555.555 0 0 1-.563.562h-3a.54.54 0 0 1-.562-.562c0-.305.234-.563.562-.563h.938V8.047l-.493.258a.526.526 0 0 1-.75-.211.526.526 0 0 1 .211-.75l1.313-.75a.6.6 0 0 1 .562 0' />
  </svg>
);
