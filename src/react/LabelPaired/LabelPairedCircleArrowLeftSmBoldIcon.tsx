...
const LabelPairedCircleArrowLeftSmBoldIcon = (
  ...
  >
    ...
    <path d='M1.313 10.75c0 2.05 1.066 3.91 2.843 4.95a5.71 5.71 0 0 0 5.688 0c1.75-1.04 2.844-2.9 2.844-4.95 0-2.023-1.094-3.883-2.844-4.922a5.71 5.71 0 0 0-5.688 0 5.68 5.68 0 0 0-2.843 4.922m12.687 0a7.02 7.02 0 0 1-3.5 6.07c-2.187 1.258-4.84 1.258-7 0A6.96 6.96 0 0 1 0 10.75a6.95 6.95 0 0 1 3.5-6.043c2.16-1.258 4.813-1.258 7 0C12.66 5.965 14 8.262 14 10.75M6.098 7.879v.027a.6.6 0 0 1 .902 0 .6.6 0 0 1 0 .903l-1.285 1.285h4.129c.355 0 .656.3.656.656 0 .383-.3.656-.656.656h-4.13L7 12.691c.273.274.273.684 0 .93a.6.6 0 0 1-.902 0L3.69 11.215c-.273-.246-.273-.656 0-.93z' />
  </svg>
);
