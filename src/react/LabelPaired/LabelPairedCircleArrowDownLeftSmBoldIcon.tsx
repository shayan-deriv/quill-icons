...
const LabelPairedCircleArrowDownLeftSmBoldIcon = (
  ...
  >
    ...
    <path d='M7 5.063c-2.05 0-3.91 1.093-4.95 2.843a5.71 5.71 0 0 0 0 5.688A5.7 5.7 0 0 0 7 16.438a5.68 5.68 0 0 0 4.922-2.844 5.71 5.71 0 0 0 0-5.688C10.882 6.156 9.023 5.063 7 5.063M7 17.75a6.96 6.96 0 0 1-6.07-3.5c-1.258-2.16-1.258-4.812 0-7A7.02 7.02 0 0 1 7 3.75c2.488 0 4.785 1.34 6.043 3.5 1.258 2.188 1.258 4.84 0 7A6.95 6.95 0 0 1 7 17.75m1.75-3.937H4.594a.63.63 0 0 1-.657-.657V8.781c0-.355.274-.656.657-.656.355 0 .656.3.656.656v2.817l3.691-3.72a.644.644 0 0 1 .903 0c.273.274.273.684 0 .93L6.152 12.5H8.75c.355 0 .656.3.656.656 0 .383-.3.656-.656.656' />
  </svg>
);
