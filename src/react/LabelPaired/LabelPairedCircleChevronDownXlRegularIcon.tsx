...
const LabelPairedCircleChevronDownXlRegularIcon = (
  ...
  >
    ...
    <path d='M12 28.5a10.36 10.36 0 0 0 9.047-5.25c1.922-3.234 1.922-7.219 0-10.5C19.172 9.516 15.75 7.5 12 7.5a10.48 10.48 0 0 0-9.094 5.25c-1.922 3.281-1.922 7.266 0 10.5C4.781 26.531 8.203 28.5 12 28.5M12 6c4.266 0 8.203 2.297 10.36 6 2.156 3.75 2.156 8.297 0 12A11.91 11.91 0 0 1 12 30c-4.312 0-8.25-2.25-10.406-6-2.157-3.703-2.157-8.25 0-12C3.75 8.297 7.688 6 12 6M6.188 17.063a.794.794 0 0 1 0-1.079c.28-.28.796-.28 1.078 0L12 20.72l4.688-4.735c.28-.28.796-.28 1.078 0 .28.282.28.797 0 1.079l-5.25 5.25c-.282.28-.797.28-1.078 0z' />
  </svg>
);
