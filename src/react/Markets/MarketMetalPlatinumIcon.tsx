...
export const MarketMetalPlatinumIcon = (
  ...
  >
    ...
    <g clipPath='url(#36bccdf6a)'>
      ...
      />
      <path fill='#B2B6BB' d='M29 16c0 7.18-5.82 13-13 13S3 23.18 3 16 8.82 3 16 3s13 5.82 13 13' />
      <path
        fill='#A8A8A8'
    ...
    <defs>
      <clipPath id='36bccdf6a'>
        <path fill='#fff' d='M0 0h32v32H0z' />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(MarketMetalPlatinumIcon);
