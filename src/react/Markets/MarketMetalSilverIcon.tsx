...
export const MarketMetalSilverIcon = (
  ...
  >
    ...
    <g clipPath='url(#ec99c2c6a)'>
      ...
      />
      <path fill='#D1D1D1' d='M29 16c0 7.18-5.82 13-13 13S3 23.18 3 16 8.82 3 16 3s13 5.82 13 13' />
      <path
        fill='#C4C4C4'
    ...
    <defs>
      <clipPath id='ec99c2c6a'>
        <path fill='#fff' d='M0 0h32v32H0z' />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(MarketMetalSilverIcon);
