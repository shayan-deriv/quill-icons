...
export const MarketMetalLeadIcon = (
  ...
  >
    ...
    <g clipPath='url(#dd66a748a)'>
      ...
      />
      <path fill='#858484' d='M29 16c0 7.18-5.82 13-13 13S3 23.18 3 16 8.82 3 16 3s13 5.82 13 13' />
      <path
        fill='#7B7A7A'
    ...
    <defs>
      <clipPath id='dd66a748a'>
        <path fill='#fff' d='M0 0h32v32H0z' />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(MarketMetalLeadIcon);
