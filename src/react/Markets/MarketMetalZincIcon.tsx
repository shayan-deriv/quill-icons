...
export const MarketMetalZincIcon = (
  ...
  >
    ...
    <g clipPath='url(#1a12872ba)'>
      ...
      />
      <path fill='#6C809E' d='M29 16c0 7.18-5.82 13-13 13S3 23.18 3 16 8.82 3 16 3s13 5.82 13 13' />
      <path
        fill='#647695'
    ...
    <defs>
      <clipPath id='1a12872ba'>
        <path fill='#fff' d='M0 0h32v32H0z' />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(MarketMetalZincIcon);
